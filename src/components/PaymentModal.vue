      ...
      <div class="trade-modal">
        ...
        <div class="trade-body">
          ...
          <PrimaryActionButton
            ...
            disabled-bg="rgba(255, 255, 255, 0.14)"
            disabled-text-color="#7f8794"
            @click="handleConfirm"
          >
    ...
    <div v-if="showMarketWarning" class="trade-overlay" style="z-index: 2002;" @click.self="showMarketWarning = false">
      <div class="trade-modal warning-modal">
        ...
        <div class="warning-actions">
          <PrimaryActionButton
            class="warning-cancel"
            height="48px"
            radius="12px"
            font-size="16px"
            font-weight="600"
            text-color="#ffffff"
            gradient-from="#333333"
            gradient-to="#333333"
            @click="showMarketWarning = false"
          >
            {{ $t("payment.cancel") || "取消" }}
          </PrimaryActionButton>
          <PrimaryActionButton
            ...
            gradient-to="#ccff00"
            @click="proceedWithMarketOrder"
          >
            {{ $t("payment.iKnow") || "我已知晓" }}
          </PrimaryActionButton>
        </div>
      </div>
    </div>

  ...
  <div class="overview-container">
      ...
      >
        <div class="record-left">
          ...
          <img
            class="record-icon"
            v-else
            src="@/assets/icon/withdraw.png"
            alt=""
          />

          <span class="record-title">{{
            record.type === "deposit"
              ? $t("assetManagement.deposit")
              : $t("assetManagement.withdraw")
          }}</span>
          <span class="record-amount">{{ formatNumber(record.amount) }}</span>
          <span class="record-unit">{{ record.unit }}</span>
        </div>
        <div class="record-right">
          <span class="record-status" :class="record.statusColor">{{
            record.statusText
          }}</span>
    ...
    <div class="asset-distribution">
      <div class="distribution-tabs">
        <div
          :class="['tab-item', { active: distTab === 'coin' }]"
          @click="distTab = 'coin'"
        >
          {{ $t("assetManagement.coin") || "币种" }}
        </div>
        <div
          :class="['tab-item', { active: distTab === 'account' }]"

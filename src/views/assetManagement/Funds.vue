  ...
  <div class="funds-container">
    ...
    <div class="total-assets-section">
      ...
      <div class="assets-value">
        <span v-if="showAssets" class="value-number">{{ formatNumber(fundsTotal) }}</span>
    ...
    <div class="asset-distribution">
      <div class="distribution-title-bar">
        <span class="title-text">{{ $t('assetManagement.coin') || '币种' }}</span>
      </div>
...
.asset-distribution {
  ...
  .distribution-list {
    .distribution-header {
      ...
      .header-value { flex: 1; text-align: right; }
    }

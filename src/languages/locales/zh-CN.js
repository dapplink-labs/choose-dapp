export default {
  ...
  payment: {
    ...
    iKnow: "我已知晓",
    marketWarning:
      "当前市场流动性较低，市价委托可能无法完成撮合。若订单未成交，将自动撤单，资金原路返还至您的资金账户。",
    cashUsed: "已用现金",
    maxTradeSize: "最大交易规模：",
    ...
    orderSuccess: "下单成功",
    orderFailed: "下单失败",
    orderSubmitted: "下单提交成功",
    orderSubmittedFailed: "下单提交失败",
    buyNo: "Buy No",
    buyYes: "Buy Yes",
  ...
  computingPower: {
    ...
    buyNow: "立即购买",
    buyButton: "购买节点",
    purchaseSuccessSubtitle: "您已成功购买节点",
    tabs: {
      distributed: "分布节点",
      cluster: "集群节点",
    },
  ...
  myNode: {
    ...
    distributedDesc: "需直推两个T1以上级别质押节点，才有全网手续费买卖收益0.5%CHO流水分红",
    clusterDesc: "需网体100个质押T1以上级别，才有全网手续费买卖收益0.5%CHO流水分红",
  ...
  myEarnings: {
    ...
    fomoPoolEarningsDesc: "预测平台盈利金额的*10%，分给当天质押6000U/14000U用户",

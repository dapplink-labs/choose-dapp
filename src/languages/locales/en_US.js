export default {
  assetManagement: {
    ...
    cancelAllOrdersConfirm: 'Cancel all open orders?',
  ...
  link: { titel: 'Connect Wallet', exit: 'Disconnect' },
  bindEmail: {
    title: 'Bind Email',
  ...
  navbar: {
    meun1: { title: 'Network', menu: { name1: 'Mainnet', name2: 'Testnet' } },
    meun2: {
      title: 'Ecosystem',
      menu: {
        name1: 'DAPP Market',
    ...
    meun3: { title: 'Builders', menu: { name1: 'Docs', name2: 'Tutorials' } },
    meun4: {
      title: 'Tool',
      menu: { name1: 'Faucet', name2: 'Batch transfer' }
    },
    meun5: { title: 'Swap' },
  ...
  messages: { title: 'Messages', detailTitle: 'Message Detail' },
  home: {
  ...
  payment: {
    ...
    cancel: 'Cancel',
    iKnow: 'I Know',
    marketWarning: 'The current market liquidity is low, and the market order may not be matched. If the order is not filled, it will be automatically canceled and the funds will be returned to your account.',
    cashUsed: 'Cash Used',
  ...
  computingPower: {
    ...
    myNodes: 'My Profit',
    buyNow: 'Buy Now',
    buyButton: 'Purchase Node',
    purchaseSuccessSubtitle: 'You have successfully purchased the node',
    tabs: { distributed: 'Distributed Node', cluster: 'Cluster Node' },
    priceLabel: 'Price:',
  ...
  myNode: {
    ...
    nodeTypes: { distributed: 'Distributed Node', cluster: 'Cluster Node' },
    ...
    distributedDesc: 'A lightweight Web3 node service that supports major blockchains, ideal for startups and individual developers to join quickly. The prediction platform integrates lightweight nodes to provide stable on-chain data reads and transaction broadcasting for ecosystem dApps. Invite your friends now and earn more rewards together.',
    clusterDesc: 'An advanced Web3 node service that supports major blockchains and serves as the core infrastructure of the prediction platform, powering high-concurrency real-time investing, on-chain oracle price feeds, and instant settlement of large prize pools. Invite your friends now and earn more rewards together.',
  ...
  myIncome: {
    ...
    earningsOptions: { allNodeRewards: 'All Node Rewards' }
  },
  claimRecord: {
    title: 'Claim Records',
  ...
  cmtCurrentPrice: {
    ...
    timePeriods: { '5m': '5m', '1h': '1h', '4h': '4h', '1d': '1d' },
    tooltip: {
      open: 'Open',
      close: 'Close',
      low: 'Low',
  ...
  cmtPledge: {
    ...
    timePeriods: { '7d': '7d', '30d': '30d', '90d': '90d', '1y': '1y', all: 'All' }
  },
  computingPool: {
  ...
  tabNode: { purchaseTime: 'Purchase Time' },
  myNodes: { title: 'Node Earnings' },
  collectEarnings: {

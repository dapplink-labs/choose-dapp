export default {
  ...
  myEarnings: {
    title: "My Earnings",
    desc: "Clear display of node and staking earnings, keeping you updated on asset growth.",
    nodeEarnings: "Node Earnings",
    nodeEarningsDesc: "Accumulated earnings from node purchases",
    stakingEarnings: "Staking Earnings",
    stakingEarningsDesc: "Settled on time based on staking cycle and rules",
    myPerformance: "My Performance",
    performanceDesc: "Actual performance subject to final settlement",
